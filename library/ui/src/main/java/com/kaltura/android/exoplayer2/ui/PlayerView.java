...
import com.kaltura.android.exoplayer2.Player.VideoComponent;
...
import com.kaltura.android.exoplayer2.ui.AspectRatioFrameLayout.ResizeMode;
import com.kaltura.android.exoplayer2.ui.spherical.SingleTapListener;
import com.kaltura.android.exoplayer2.ui.spherical.SphericalSurfaceView;
 ...
 *       <ul>
 *         <li>Corresponding method: None
 *         <li>Default: {@code R.layout.kaltura_exo_player_view}
 *       </ul>
 ...
 * you can define {@code kaltura_exo_player_view.xmlview.xml} layout files in your application {@code res/layout*}
 ...
 *
 * Defining your own {@code kaltura_exo_player_view.xmlview.xml} is useful to customize the layout of PlayerView
 ...
 * kaltura_exo_player_view.xmlview.xml} for only the instance on which the attribute is set.
 */
public class PlayerView extends FrameLayout {
  ...
  public PlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    int shutterColor = 0;
    int playerLayoutId = R.layout.kaltura_exo_player_view;
    ...
    // Content frame.
    contentFrame = findViewById(R.id.kaltura_exo_content_frame);
    if (contentFrame != null) {
      setResizeModeRaw(contentFrame, resizeMode);
    }

    // Shutter view.
    shutterView = findViewById(R.id.kaltura_exo_shutter);
    ...
    overlayFrameLayout = findViewById(R.id.kaltura_exo_overlay);

    // Artwork view.
    artworkView = findViewById(R.id.kaltura_exo_artwork);
    ...
    // Subtitle view.
    subtitleView = findViewById(R.id.kaltura_exo_subtitles);
    ...
    // Buffering view.
    bufferingView = findViewById(R.id.kaltura_exo_buffering);
    ...
    // Error message view.
    errorMessageView = findViewById(R.id.kaltura_exo_error_message);
    if (errorMessageView != null) {
      errorMessageView.setVisibility(View.GONE);
    }

    // Playback control view.
    PlayerControlView customController = findViewById(R.id.kaltura_exo_controller);
    View controllerPlaceholder = findViewById(R.id.kaltura_exo_controller_placeholder);
