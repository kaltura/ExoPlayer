...
public final class TtmlRenderUtilTest {
  ...
  public void testResolveStyleMultipleReferentialStyles() {
    ...
    // inherited from s1
<<<<<<< HEAD:library/src/androidTest/java/com/google/android/exoplayer/text/ttml/TtmlRenderUtilTest.java
    assertEquals(Color.RED, resolved.getFontColor());
=======
    assertThat(resolved.getFontColor()).isEqualTo(RED);
>>>>>>> 71f72c59537711399dc5496136dd6b867acc6d77:library/core/src/test/java/com/google/android/exoplayer2/text/ttml/TtmlRenderUtilTest.java
