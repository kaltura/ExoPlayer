...
import com.google.android.kexoplayer2.analytics.AnalyticsCollector;
import com.google.android.kexoplayer2.analytics.AnalyticsListener;
import com.google.android.kexoplayer2.audio.AudioAttributes;
import com.google.android.kexoplayer2.audio.AudioFocusManager;
import com.google.android.kexoplayer2.audio.AudioListener;
import com.google.android.kexoplayer2.audio.AudioRendererEventListener;
import com.google.android.kexoplayer2.audio.AuxEffectInfo;
import com.google.android.kexoplayer2.decoder.DecoderCounters;
...
import com.google.android.kexoplayer2.trackselection.TrackSelector;
...
import com.google.android.kexoplayer2.video.spherical.CameraMotionListener;
...
public class SimpleExoPlayer extends BasePlayer
  ...
  /** @deprecated Use {@link com.google.android.kexoplayer2.video.VideoListener}. */
  @Deprecated
  public interface VideoListener extends com.google.android.kexoplayer2.video.VideoListener {}
  ...
  private final CopyOnWriteArraySet<com.google.android.kexoplayer2.video.VideoListener>
      videoListeners;
  ...
  @Override
  public void addVideoListener(com.google.android.kexoplayer2.video.VideoListener listener) {
    videoListeners.add(listener);
  }

  @Override
  public void removeVideoListener(com.google.android.kexoplayer2.video.VideoListener listener) {
   ...
   * @deprecated Use {@link #addVideoListener(com.google.android.kexoplayer2.video.VideoListener)}.
   */
  @Deprecated
  ...
  /**
   * Equivalent to {@link #removeVideoListener(com.google.android.kexoplayer2.video.VideoListener)}.
   *
   * @param listener The listener to clear.
   * @deprecated Use {@link
   *     #removeVideoListener(com.google.android.kexoplayer2.video.VideoListener)}.
   */
  @Deprecated
  @SuppressWarnings("deprecation")
  ...
  private void maybeNotifySurfaceSizeChanged(int width, int height) {
    if (width != surfaceWidth || height != surfaceHeight) {
      ...
      for (com.google.android.kexoplayer2.video.VideoListener videoListener : videoListeners) {
